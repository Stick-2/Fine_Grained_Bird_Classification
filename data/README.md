...
------- List of family names (families.txt) ------
The list of class names (bird family labels) is contained in the file `families.txt`, with each line corresponding to one family:

`<family_id> <family_name>`
--------------------------------------------


------- Image family labels (image_family_labels.txt) ------
The ground truth family labels for each image are contained in the file `image_family_labels.txt`, with each line corresponding to one image:

`<image_id> <family_id>`

where `<image_id>` and `<family_id>` correspond to the IDs in `images.txt` and `families.txt`, respectively.
---------------------------------------------------------
